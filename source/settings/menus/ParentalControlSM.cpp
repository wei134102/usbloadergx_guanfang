	...
	: SettingsMenu(tr("Parental Control"), &GuiOptions, MENU_NONE)
{
	...
	Options->SetName(Idx++, "%s", tr( "Block Miscellaneous Settings" ));
	Options->SetName(Idx++, "%s", tr( "Block Banner Settings" ));
	...
	Options->SetName(Idx++, "%s", tr( "Block Update Menu" ));
	...
	Options->SetName(Idx++, "%s", tr( "Block HBC Title Launcher" ));
	...
	Options->SetName(Idx++, "%s", tr( "Block SD Card Mode Button" ));
	Options->SetName(Idx++, "%s", tr( "Block Game Type Button" ));
	Options->SetName(Idx++, "%s", tr( "Block Game Sources Button" ));
...
void ParentalControlSM::SetOptionValues()
{
	...
	//! Settings: Block Miscellaneous Settings
	Options->SetValue(Idx++, "%s", tr(OnOffText[((Settings.ParentalBlocks & BLOCK_FEATURE_SETTINGS) != 0)]));

	//! Settings: Block Banner Settings
	Options->SetValue(Idx++, "%s", tr(OnOffText[((Settings.ParentalBlocks & BLOCK_BANNER_SETTINGS) != 0)]));
	...
	//! Settings: Block HBC Title Launcher
	...
	//! Settings: Block SD Card Mode Button
	Options->SetValue(Idx++, "%s", tr(OnOffText[((Settings.ParentalBlocks & BLOCK_SD_MODE_BUTTON) != 0)]));

	//! Settings: Block Game Type Button
	Options->SetValue(Idx++, "%s", tr(OnOffText[((Settings.ParentalBlocks & BLOCK_GAME_TYPE_BUTTON) != 0)]));

	//! Settings: Block Game Sources Button
	Options->SetValue(Idx++, "%s", tr(OnOffText[((Settings.ParentalBlocks & BLOCK_GAME_SOURCES_BUTTON) != 0)]));
...
int ParentalControlSM::GetMenuInternal()
{
	...
	{
		Settings.ParentalBlocks ^= BLOCK_BANNER_SETTINGS;
	}
	...
	{
		Settings.ParentalBlocks ^= BLOCK_SD_MODE_BUTTON;
	}

	//! Settings: Block Game Type Button
	else if (ret == ++Idx)
	{
		Settings.ParentalBlocks ^= BLOCK_GAME_TYPE_BUTTON;
	}

	//! Settings: Block Game Sources Button
	else if (ret == ++Idx)
	{
		Settings.ParentalBlocks ^= BLOCK_GAME_SOURCES_BUTTON;
	}
